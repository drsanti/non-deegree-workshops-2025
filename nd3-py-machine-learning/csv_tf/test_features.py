...
# Load trained feature-based model and evaluate on test dataset
# ==============================================================================
...
print("="*60)
print("Loading Trained Feature-Based Model")
print("="*60)

model_path = "models/features_model.h5"
...
X_test, y_test, condition_names = load_csv_data_with_features("test")
...
plt.title('Feature-Based Model - Test Set Confusion Matrix', fontsize=14, fontweight='bold')
